...
public class StringUtil {
    ...
    public static String formatDuration(long duration, Locale inlocale) {
        return formatDuration(duration, 0, false, inlocale);
    }
    
    public static String formatDuration(long duration, int scale,
            boolean minDigits)
    {
    	return formatDuration(duration, scale, minDigits, Locale.getDefault());
    }
    
    public static String formatDuration(long duration, int scale,
                                        boolean minDigits, Locale inlocale)
    {
        long hours, mins;
        int digits;
        double millis;
