            ...
            var mouseMoveHandler = function(elmt, evt, target) {
                if (typeof SimileAjax != "undefined" && plot._plotInfo.showValues) {
                    ...
                    if (p < day) {
						...
						if(hqDojo.date.locale.format(d, {formatLength:'medium'})){
							plot._timeFlag.innerHTML = hqDojo.date.locale.format(d, {formatLength:'medium'});
						}else{
    ...
    _calculateGrid: function() {
        ...
        do {
            ...
            switch (unit) {
                ...
                case time.MONTH:
					var l = '';
					if(hqDojo.date.locale.format(t, {selector:'date',formatLength:'medium'})){
						l = hqDojo.date.locale.format(t, {selector:'date',formatLength:'medium'});
					}else{
						l = t.formatDate('MM/dd/yyyy');
					}                  
                  break;  
                case time.YEAR:
                case time.DECADE:
