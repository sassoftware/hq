...
<div class="outerLiveDataCont" style="clear:both;">
  ...
  <div class="leftbx">
    ...
    <div class="leftboxborder">
      ...
      <div class="BlockTitle"><div style="float:left;">${l.executeCommand}</div><div class="acLoader2" id="spinner" style="display:inline;float:right;"></div>
      <br class="clearBoth">
      </div>
      ...
      <div class="fivepad">
        ...
        <div style="padding-left:5px;">
            <div class="instruction1">${l.selectQuery}</div>
