...
<div class="downContainer" style="clear:both;">
    ...
    <div class="downTableContainer" id="downCont">
        ...
        <%def headerHTML = '<div style="float: right; margin-top:5px;padding-right:15px;">' + "${l.tableheader}" + ':&nbsp;<span id="50" onclick="updateFilterCount(50, this)" class="countLinksActive">50</span>&nbsp;|&nbsp;<span id="100" onclick="updateFilterCount(100, this)" class="countLinksActive">100</span>&nbsp;|&nbsp;<span id="1000"  onclick="updateFilterCount(1000,this)" class="countLinksActive">1000</span></div>'%>
...
<script type="text/javascript">
						hqDojo.require("dijit.dijit");
			          	...
			          	hqDojo.ready(function(){		          		
			          		hqDojo.connect("SystemsDown_refreshTable","onchange",function(){RefreshTable();});
...
hquTitle.innerHTML="${l.systemsdowndescription}";

var timer =0;
setTimeout(RefreshTable, 151);


function RefreshTable(){
  clearInterval(timer);
  timer = setInterval(runUpdateSystemdownTable, 100);
}

	
function runUpdateSystemdownTable() {
	    var defObject =document.getElementById("SystemsDownHdr1");
		if ( defObject==null){
		 return;
		}	
        var freshBtn = document.getElementById("SystemsDown_pageCont").getElementsByTagName("img")[0];
		freshBtn.setAttribute("title","${l.SystemDownBTNRefresh}");
		clearInterval(timer);
	}
