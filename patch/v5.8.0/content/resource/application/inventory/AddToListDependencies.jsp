...
<tiles:insert definition=".header.tab">
  ...
  <tiles:put name="useFromSideBar" value="true"/>
      ...
      <td>
<tiles:insert definition=".header.tab">
  <tiles:put name="tabKey" value="SomeServiceName: resource.application.AddDependenciesTab"/>
		...
		<table width="100%" cellpadding="5" cellspacing="0" border="0" class="ToolbarContent">
			<tr>
				...
				<table cellpadding="0" cellspacing="0" border="0">
					<tbody id="navTBody">
						<tr id="navRow">
							<td><html:img page="/images/tbb_pageleft_gray.gif" width="19" height="16" border="0" altKey="button.prev"/></td>
							...
							<td><html:img page="/images/spacer.gif" width="3" height="1" border="0"/></td>
							<td><html:img page="/images/tbb_pageright.gif" width="19" height="16" border="0" altKey="button.next"/></td>
						</tr>
					</tbody>
				</table>
				</td>
