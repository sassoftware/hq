    ...
    <c:choose>
      <c:when test="${isCurrentHealth}">
        <html:form
          ...
          <tiles:insert page="/resource/service/monitor/visibility/CurrentHealthResources.jsp">
            <tiles:put name="mode" beanName="mode"/>
      ...
      <c:when test="${isResourceMetrics}">
        <html:form action="/resource/service/monitor/visibility/FilterServiceMetrics">
          <input type="hidden" name="eid" value="<owasp:forHtmlUnquotedAttribute value="${eid}"/>">
          <tiles:insert page="/resource/service/monitor/visibility/CurrentHealthResources.jsp">
            <tiles:put name="mode" beanName="mode"/>
...
<c:choose>
  ...
  <c:when test="${isResourceMetrics}">
    <tiles:insert page="/resource/service/monitor/visibility/ServiceMetrics.jsp">
      <tiles:put name="entityId" beanName="entityId"/>
      <tiles:put name="IsPlatformService" beanName="IsPlatformService"/>
    </tiles:insert>
  </c:when>
  <c:otherwise>
    <c:out value="${mode}"/>
