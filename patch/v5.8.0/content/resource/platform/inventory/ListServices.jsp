...
<!--  SERVICES CONTENTS -->
  <display:table items="${services}" cellspacing="0" cellpadding="0" width="100%" action="${ssAction}" var="service" pageSizeValue="ps" pageSize="${param.ps}" pageValue="pn" page="${param.pn}" orderValue="so" order="${owasp:forUriComponent(param.so)}" sortValue="sc" sort="${param.sc}">
