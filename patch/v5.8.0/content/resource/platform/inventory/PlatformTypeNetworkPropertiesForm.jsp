...
<logic:messagesPresent property="ip[${i}].netmask">
    <td width="30%" class="ErrorField">
		<html:text size="30" maxlength="200" property="ip[${i}].netmask"/><br>
		<span class="ErrorFieldContent">- <html:errors property="ip[${i}].netmask"/></span>
	</td>
</logic:messagesPresent>
<logic:messagesNotPresent property="ip[${i}].netmask">
