      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        ...
        <c:if test="${scanstate.startTime > 0 && !scanstate.isDone }"> <!-- there's a scan -->
          <tr valign="middle">
            ...
            <td>
              <html:image page="/images/fb_abort.gif" border="0" altKey="button.abort" property="abort" onmouseover="imageSwap(this, imagePath + 'fb_abort', '_over');" onmouseout="imageSwap(this, imagePath +  'fb_abort', '');" onmousedown="imageSwap(this, imagePath +  'fb_abort', '_down')"/>
            </td>
          </tr>
        </c:if>
        <c:if test="${scanstate.startTime > 0 && scanstate.isDone }"> <!-- there's a scan -->
