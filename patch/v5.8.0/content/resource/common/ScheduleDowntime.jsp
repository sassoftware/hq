...
<div id="maintenance<c:out value='${resource.id}'/>">
	...
	<div class="ScheduleDefineDiv">    
	<fieldset>
		<legend><fmt:message key="resource.group.MaintenanceWindow.From"/>:</legend>
        <label for="from_date" class="BlackFontColor"><fmt:message key="resource.group.MaintenanceWindow.Date"/>:&nbsp;</label>
        <input type="text" name="from_date" id="from_date" /><br />
        <label for="from_time" id="maintenance_from_time_timezone" class="BlackFontColor"></label>
        <input type="text" name="from_time" id="from_time" />
    </fieldset>
    <fieldset>
		<legend><fmt:message key="resource.group.MaintenanceWindow.To"/>:</legend>
        <label for="to_date" class="BlackFontColor"><fmt:message key="resource.group.MaintenanceWindow.Date" />:&nbsp;</label>
        <input type="text" name="to_date" id="to_date" /><br />
        <label for="to_time" id="maintenance_to_time_timezone" class="BlackFontColor"></label>
	...
	<span id="cancel_schedule_btn"></span>
	</div>
</div>
<jsu:script>
