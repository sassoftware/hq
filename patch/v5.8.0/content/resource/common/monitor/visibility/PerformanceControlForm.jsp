    ...
    <td width="80%">
      <table width="100%" cellpadding="3" cellspacing="0" border="0">
        <tr>
          ...
          <td colspan="5"><html:image page="/images/fb_redraw.gif" altKey="button.redraw" property="redraw" border="0" onmouseover="imageSwap(this, imagePath + 'fb_redraw', '_over');" onmouseout="imageSwap(this, imagePath +  'fb_redraw', '');" onmousedown="imageSwap(this, imagePath +  'fb_redraw', '_down')"/></td>
          <td width="41%">&nbsp;</td>
