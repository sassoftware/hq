      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        ...
        <tr>
          <td class="MonitorChartCell"
			...
			<%				
				String averageLabel = LocaleSupport.getLocalizedMessage(pageContext,"reource.metric.chart.average");
				String baselineLabel = LocaleSupport.getLocalizedMessage(pageContext,"reource.metric.chart.baseline");
				String lowLabel = LocaleSupport.getLocalizedMessage(pageContext,"reource.metric.chart.low");
				String peakLabel = LocaleSupport.getLocalizedMessage(pageContext,"reource.metric.chart.peak");
				String timeLabel = LocaleSupport.getLocalizedMessage(pageContext,"reource.metric.chart.time");
				String valueLabel = LocaleSupport.getLocalizedMessage(pageContext,"reource.metric.chart.value");
			%>
          <td class="MonitorChartCell" width="755">
			...
			<c:param name="averageLabel" value="<%=averageLabel%>" />
			<c:param name="baselineLabel" value="<%=baselineLabel%>" />
			<c:param name="lowLabel" value="<%=lowLabel%>" />
			<c:param name="peakLabel" value="<%=peakLabel%>" />
			<c:param name="timeLabel" value="<%=timeLabel%>" />
			<c:param name="valueLabel" value="<%=valueLabel%>" />
            </c:url>
