...
<c:choose>
  ...
  <c:otherwise>&nbsp;</c:otherwise>
      ...
      <td width="5%" class="ListHeaderInactiveSorted" align="center">
      ...
      <c:if test="${MetricsDisplayForm.showBaseline}">
      <td width="10%" class="ListHeaderInactiveSorted">
        <html:select property="t" styleClass="FilterFormText" size="1" onchange="clickLink('MetricsDisplayForm', 'threshold'); this.form.submit();">
          <hq:optionMessageList property="thresholdMenu" baseKey="resource.common.monitor.visibility.metricsToolbar" filter="true"/>
        </html:select>
      </td>
      </c:if>
