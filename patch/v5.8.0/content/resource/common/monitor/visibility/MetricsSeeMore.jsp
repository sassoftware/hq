...
<c:choose>
 ...
 <table width="100%" cellpadding="5" cellspacing="0" border="0" class="MonitorToolBar">
  <tr>
    ...
    <html:link href="javascript:reverseListing();"><html:img page="/images/4.0/icons/accept.png" altKey="resource.common.monitor.visibility.metricdata.metric.type.showallmetrics" titleKey="resource.common.monitor.visibility.metricdata.metric.type.showallmetrics" border="0"/></html:link>
    </td>
  </tr>
</table>
</c:if>
