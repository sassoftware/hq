...
--%>
  ...
  <tr class="ListRow">
    ...
    <td class="ListCellCheckbox" valign="top"><html:multibox
      ...
      onclick="uncheckValidate(this);ToggleSelection(this, widgetProperties);"
...
<table width="100%" cellpadding="5" cellspacing="0" border="0" class="ToolbarContent">
  <tr>
    <td id="<c:out value="${widgetInstanceName}"/>RedrawTd"><div
      id="<c:out value="${widgetInstanceName}"/>RedrawDiv"><input id="<c:out value="${widgetInstanceName}"/>RedrawButton" type="button" class="button42" value="<fmt:message key='button.redrawselectedonchart' />" disabled="disabled" /></div></td>
...
<%--
    ...
    <td><html:image property="redraw"
      page="/images/4.0/icons/accept.png" altKey="button.ok" border="0"/></td>
--%>
  </tr>
</table>
<!--  /  -->
...
<jsu:script>
	...
	function uncheckValidate(widget){
		var checked=false;
