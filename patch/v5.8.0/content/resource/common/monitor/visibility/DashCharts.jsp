...
<c:otherwise>
  ...
  <c:set var="fmtBegin"><sas:evmTimelineTag value="${begin}"/></c:set>
  <c:set var="fmtEnd"><sas:evmTimelineTag value="${end}"/></c:set>
...
<ul id="root" class="boxy">
	...
	<script>
		...
		var props = { 
				  ...
				  "view" : "<owasp:forUriComponent value="${IndicatorViewsForm.view}"/>",
				  "eid" : "<owasp:forUriComponent value="${eid}"/>",
		  ...
		  props.labels = {
				  ...
				  "chartTitle" : "<fmt:message key="resource.common.monitor.visibility.indicator.metric.type.chart"/>",
				  "moveupTitle" : "<fmt:message key="resource.common.monitor.visibility.indicator.metric.type.moveup"/>",
				  "movedownTitle" : "<fmt:message key="resource.common.monitor.visibility.indicator.metric.type.movedown"/>",
			      "removeTitle" : "<fmt:message key="resource.common.monitor.visibility.indicator.metric.type.remove"/>"
		  }		  
