...
<sas:evmTimelineTag var="rb" value="${rangeBegin}"/>
<sas:evmTimelineTag var="re" value="${rangeEnd}"/>
...
<c:choose>
  <c:when test="${readOnly}">
    <td>
      <table width="100%" cellpadding="0" cellspacing="3" border="0">
        <tr>
          <td><html:image property="prevRange" page="/images/tbb_pageleft.gif" border="0" altKey="button.prev"/></td>
          ...
          <td><html:image property="nextRange" page="/images/tbb_pageright.gif" border="0" altKey="button.next"/></td>
          <td width="100%" style="padding-left: 5px;">
          <a href='<html:rewrite page="/ResourceCurrentHealth.do?eid=${owasp:forUriComponent(eid)}&view=${owasp:forUriComponent(view)}&alertDefaults=true"/>'>
  ...
  <c:otherwise>
    <td>
      <table width="100%" cellpadding="0" cellspacing="3" border="0">
        <tr>
          <td><html:image altKey="button.prev" property="prevRange" page="/images/tbb_pageleft.gif" border="0"/></td>
          <td nowrap><fmt:message key="resource.common.monitor.visibility.metricsToolbar.Last"/></td>
          <td nowrap>
...
-->
          ...
          <td><html:image property="range" page="/images/4.0/icons/accept.png" border="0" altKey="button.ok"/></td>
          <td width="100%" style="padding-left: 5px;">
            <a href='<html:rewrite page="/ResourceCurrentHealth.do?eid=${owasp:forUriComponent(eid)}&view=${owasp:forUriComponent(view)}&alertDefaults=true"/>'>
            <c:if test="${form.a != 1 || (rangeEnd - rangeBegin) > 172800000}">
              <fmt:message key="resource.common.monitor.visibility.now"/></a>&nbsp;<fmt:message key="common.label.Pipe"/>&nbsp;
            </c:if>
			<a href="#" onclick="advancedDialog.show();return false;"><fmt:message key="resource.common.monitor.visibility.metricsToolbar.EditRangeBtn"/></a>
          </td>
        </tr>
      </table>
    </td>
