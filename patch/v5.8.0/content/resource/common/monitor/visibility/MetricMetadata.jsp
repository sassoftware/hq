...
<display:eventdatetimedecorator /></display:column>
...
<td width="10%">
<a href="javascript:window.close()"><fmt:message key="resource.agent.measurement.button.message"/></a>
</td>
<td width="10%">
<a href="javascript:location.reload()"><fmt:message key="admin.managers.Plugin.information.refresh.png.title"/></a>
</td>
<td width="40%">
&nbsp;
</td>
