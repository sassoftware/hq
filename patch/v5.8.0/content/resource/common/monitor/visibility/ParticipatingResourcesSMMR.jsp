...
<table width="100%" cellpadding="0" cellspacing="0" border="0" id="listTable">
  ...
  <tr class="ListRow">
    ...
    <td class="ListCellLeftLineNoPadding" valign="top"><html:multibox
      ...
      onclick="ToggleSelection(this, widgetProperties, null, '${maxMessage}');"
...
<table width="100%" cellpadding="5" cellspacing="0" border="0" class="ToolbarContent">
  <tr>
    <td id="<c:out value="${widgetInstanceName}"/>RedrawTd"><div
      id="<c:out value="${widgetInstanceName}"/>RedrawDiv"><input onclick="clickRedrawButton();" id="<c:out value="${widgetInstanceName}"/>RedrawButton" type="button" class="button42" value="<fmt:message key='button.redrawselectedonchart' />"  /></div></td>
