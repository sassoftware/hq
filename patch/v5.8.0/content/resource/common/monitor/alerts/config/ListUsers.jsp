...
<display:table cellspacing="0" cellpadding="0" width="100%" action="${selfUrl}" pageSize="${pageSize}" items="${notifyList}">
  ...
  <display:column width="24%" property="name" sort="true" sortAttr="0" defaultSort="true" title="alert.config.props.NB.Username" href="/admin/user/UserAdmin.do?mode=view" paramId="u" paramProperty="id"/>
  <display:column width="25%" property="firstName" sort="true" sortAttr="2" defaultSort="false" title="alert.config.props.NB.FirstName"/>
  <display:column width="25%" property="emailAddress" title="alert.config.props.NB.Email" autolink="true"/>
  <display:column width="25%" property="department" title="alert.config.props.NB.Dept"/>
</display:table>
