	...
	<c:choose>
		...
		function showViewEscResponse() {
		    ...
		    for (i = 0; i < actions.length; i++) {
		      ...
		      td6.innerHTML = '<fmt:message key="common.label.escalation.actiondetail" />: ' + (i+1) ;
		      ...
		      var actionClass = actionsClassName.split('.');
		        ...
		        for (var d = 0; d < actionClass.length; d++) {
		            ...
		            usersTextDiv.innerHTML = '<table cellpadding="0" cellspacing="0" border="0"><tr><td rowSpan="4" vAlign="top" style="padding-right:3px;"><fmt:message key="admin.config.escalation.log.to.sys.log" /></td><td>&nbsp;</td></tr><tr><td style="padding:0px 2px 2px 2px;"><fmt:message key="common.label.escalation.action.syslog.meta" /> ' + configMeta + '</td></tr><tr><td style="padding:2px;"><fmt:message key="common.label.escalation.action.syslog.product" /> ' + configProduct + '</td></tr><tr><td style="padding:2px 2px 2px 2px;"><fmt:message key="common.label.escalation.action.syslog.version" /> ' + configVersion + '</td></tr></table>'                   
