      ...
      hqDojo.xhrGet( {
          ...
          load: function(status){
            ...
            if (status.ctrlStatus != 'In Progress') {
              ...
              hqDojo.byId('ctrlStart').innerHTML = hqDojo.date.locale.format(new Date(status.ctrlStart), {formatLength:'medium'});
              hqDojo.byId('ctrlSched').innerHTML = hqDojo.date.locale.format(new Date(status.ctrlSched), {formatLength:'medium'});
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr valign="top">
        ...
        <td width="30%" class="BlockContent"><span id="ctrlStart"><sas:evmEventDateTimeTag value="${controlCurrentStatus.startTime}"/></span></td>
    </tr>
    <tr valign="top">
        ...
        <td width="30%" class="BlockContent"><span id="ctrlSched"><sas:evmEventDateTimeTag value="${controlCurrentStatus.dateScheduled}"/></span></td>
    </tr>
    <tr valign="top">
