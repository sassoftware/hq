...
<c:otherwise>
 <c:choose>
  ...
  <c:otherwise>
   ...
   <c:set var="tmpMessage">
    <fmt:message key="resource.common.control.NotEnabled.ControlNotEnabled"/> <fmt:message key="resource.common.control.NotEnabled.ToEnableControl"><fmt:param value="${enableControlLink}" /></fmt:message>
   </c:set>
  </c:otherwise>
 </c:choose>
