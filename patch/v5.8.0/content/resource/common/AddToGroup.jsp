...
<div id="add_to_existing_group_dialog" style="display:none;">
	...
	<div id="AddToExistingGroupDiv" style="width:500px; height:320px;">
					...
					<table width="100%" cellpadding="0" cellspacing="0" border="0">
						<thead>
							<tr class="tableRowHeader">
								...
								<th class="tableRowInactive" style="width:52%"><fmt:message key="resource.type.Group" /></td>
								<th class="tableRowInactive"><fmt:message key="common.label.Description" /></td>
							</tr>
						</thead>
						<tfoot id="AddToExistingGroupTableFooter">
							<tr>
								<td colspan="3"><fmt:message key="resource.common.label.loading"/></td>
							</tr>
						</tfoot>
			...
			<table cellspacing="0" cellpadding="0">
				<tr>
					<td valign="middle" nowrap="true">
						<input type="button" id="AddToExistingGroupButton" value="<fmt:message key="resource.common.button.AddToExistGroup" />" class="CompactButton" onclick="javascript:MyGroupManager.addResourcesToGroups(this.form);" />
						&nbsp;&nbsp;
  						<input type="button" id="AddToNewGroupButton" value="<fmt:message key="resource.common.button.AddToNewGroup" />" class="CompactButton" onclick="javascript:MyGroupManager.addNewGroup(this.form.eid.value);" />
					</td>
				</tr>
			</table>
		</div>
...
<jsu:script>
    ...
    var alertAddExistingErrorText="<fmt:message key='resoure.Alert.action.error'/>";
    var alertAddExistingSucessText="<fmt:message key='resoure.Alert.action.sucess'/>";
...
<jsu:script onLoad="true">
   	MyGroupManager = new hyperic.group_manager({
		...
		groupManagerTitle:"<fmt:message key="header.group"/>"
   	});
</jsu:script>