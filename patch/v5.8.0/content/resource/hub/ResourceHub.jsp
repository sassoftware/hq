...
<tiles:insert definition=".page.title.resource.hub">
  <tiles:put name="titleName"><span id="browseFilters"><c:out value="${resourceTitle}"escapeXml="false" /></span></tiles:put>
</tiles:insert>
...
<c:choose>
  <c:when test="${ResourceHubForm.view == LIST}">
    ...
    <html:link action="/resource/${section}/monitor/Visibility" paramId="eid" paramName="resource" paramProperty="entityId">
    	...
    	<html:img page="/images/icon_hub_m.gif" width="11" height="11" altKey="resource.hub.NavToMonitor" border="0"/>
    </html:link>
    <html:link action="/resource/${section}/Inventory" paramId="eid" paramName="resource" paramProperty="entityId">
    	...
    	<html:img page="/images/icon_hub_i.gif" width="11" height="11" altKey="resource.hub.NavToInventory"  border="0"/>
    </html:link>
    <c:if test="${resource.entityId.type == 1 || resource.entityId.type == 2 || resource.entityId.type == 3}">
    	<html:link action="/alerts/Config" paramId="eid" paramName="resource" paramProperty="entityId">
    		...
    		<html:img page="/images/icon_hub_a.gif" width="11" height="11" altKey="resource.hub.NavToAlert" border="0"/>
    	</html:link>
    </c:if>
    </td>
      ...
      <td class="tableCell" align="middle" valign="top">
        <html:img imageName="avail${resource.id}" altKey="avail${resource.id}" page="/resource/Availability?timeout=30000" paramId="eid" paramName="resource" paramProperty="entityId"/>
      </td>
    </tr>
    </c:forEach>
    </table>
