    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
     <tr>
      ...
      <logic:messagesPresent property="availabilityThreshold">
       <td width="30%" class="BlockContent" nowrap="true"><fmt:message key="resource.group.monitor.visibility.config.availableCondition"/> <html:text size="2" property="availabilityThreshold"/>% </td>
      ...
      <logic:messagesPresent property="unavailabilityThreshold">
       <td width="30%" class="BlockContent" nowrap="true"><fmt:message key="resource.group.monitor.visibility.config.availableCondition"/> <html:text size="2" property="unavailabilityThreshold"/>% </td>
      </logic:messagesPresent>
