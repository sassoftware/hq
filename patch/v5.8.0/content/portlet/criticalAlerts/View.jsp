...
<jsu:script onLoad="true">
	...
	setRecentAlertsResources("<fmt:message key='yesno.true'/>", "<fmt:message key='yesno.false'/>", "<fmt:message key='resoure.Alert.action.ack'/>");
  		...
  		<table width="100%" cellpadding="0" cellspacing="0" border="0" id="<c:out value="${tableName}"/>" class="portletLRBorder">
     		<thead>
				<tr class="ListRow">
					<td width="1%" class="ListHeaderCheckbox">
						<input type="checkbox" onclick="MyAlertCenter.toggleAll(this)" onfocus="focusOn(this);" onblur="focusOff(this);" name="listToggleAll" id="<c:out value="${widgetInstanceName}${portlet.token}"/>_CheckAllBox" >
					</td>
					<td width="30%" class="ListHeaderInactiveSorted" align="left">
						<fmt:message key="dash.home.TableHeader.DateTime"/>
					</td>
					...
					<td width="4%" class="ListHeaderInactive" align="center" nowrap>
						<fmt:message key="alerts.alert.AlertList.ListHeader.Fixed"/>
					</td>
					<td width="5%" class="ListHeaderInactive" align="center" nowrap>
     		...
     		<tfoot>
         		...
         		<tr class="ListRow" id="<c:out value="ackInstruction${portlet.token}"/>" style="display: none;">
           			<td class="ListCell" colspan="6" align="right">
