...
<div class="effectsPortlet">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" id="escalationTable" class="portletLRBorder">
 		<tbody>
        	<tr class="tableRowHeader">
            	<th width="40%" class="tableRowInactive" noWrap>Problem Resource</th>
            	<th width="30%"  class="tableRowInactive" noWrap>Alert Name</th>
            	<th width="10%" class="tableRowInactive" align="center" noWrap>Time Elapsed</th>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
    	<tr>
    		<td id="modifiedFavoriteTime" class="modifiedDate"></td>
      </tr>
    </table>
   	<div id="logInfo"></div>
