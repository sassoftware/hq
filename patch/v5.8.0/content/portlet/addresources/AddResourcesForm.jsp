...
<c:url var="selfAction" value="/Admin.do" context="/dashboard">
  ...
  <c:param name="key" value="${owasp:forUriComponent(param.key)}"/>
  ...
  <c:when test="${noFilter}">
    <td width="50%" valign="top">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
        ...
        <tr>
          <td nowrap="nowrap" class="FilterLabelText" colspan="2"><fmt:message key="resource.group.inventory.Edit.FilterByNameLabel"/>&nbsp;
              <html:text property="nameFilter" maxlength="55" size="10"
                     onkeypress="if (event.keyCode == 13) return goToLocationSelfAndElement('nameFilter', 'nameFilter', '${nfAction}');" />
