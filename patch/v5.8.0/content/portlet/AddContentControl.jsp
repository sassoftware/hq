...
<form method="POST" action="<html:rewrite page="/app/dashboard/${selectedDashboardId}/portlets" />" onsubmit="return isDivAddContents<c:out value='${wide}' />PortletValid()">
    ...
    <tr>
      ...
      <td>&nbsp;</td>
      <td width="100%"><html:image page="/images/4.0/icons/add.png" border="0" titleKey="FormButtons.ClickToAdd" property="ok" onfocus="focusOn(this);" onblur="focusOff(this);"/></td>
    </tr>
  </table>
</form>
</div>
