...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr class="PageTitle"> 
    ...
    <td width="67%" class="PortletTitle" nowrap><fmt:message key="dash.home.RecentlyApproved.Title"/></td>
...
<div id="narrowlist_false">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0">
         <tr>
          <td width="20%" class="BlockLabel" valign="center" nowrap><fmt:message key="dash.settings.recentlyApproved.rangeLabel"/></td>
