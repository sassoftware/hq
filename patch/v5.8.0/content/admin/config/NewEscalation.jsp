...
<jsu:script>
    ...
    function showResponse(originalRequest) {
	  ...
	  if(escJson.error){
	      ...
	      if(escJson.error=="An escalation with this name already exists."){
  ...
  <tbody>
    <tr>
      <td class="BlockTitle" colspan="2">
          <fmt:message key="common.label.escalation.Step1" /> - <fmt:message key="common.label.CreateNew" />
          <c:choose>
    ...
    <tr class="ListRow">
      ...
      <td style="padding:3px;" align="left" width="80%">
          <input type="text" size="30" maxlength="30" name="name" id="escName" />
      </td>
    </tr>
    <tr class="ListRow">
        ...
        <tbody>
          <tr>
            <td>
				...
				<fmt:message key="alert.config.escalation.allow.pause" />(<fmt:message key="alert.config.escalation.allow.pause.maxTime"/>&nbsp;</span><span id="endBracket">)</span>
			</td>
          </tr>
          <tr>
            <td><input
