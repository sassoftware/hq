...
<table width="100%" cellpadding="0" cellspacing="0" border="0" class="TableBottomLine">
  	<tr>
	    ...
	    <table width="100%" cellpadding="0" cellspacing="0" border="0">
	    	<tr>
				<logic:messagesPresent property="baseUrl">
         				<td class="ErrorField">
           				<html:text size="31" property="baseUrl" />
         				</td> 
				</logic:messagesPresent>
				<logic:messagesNotPresent property="baseUrl"> 
			...
			<logic:messagesPresent property="baseUrl">
        			<tr>
          				<td class="ErrorField" colspan="2">
            				<span class="ErrorFieldContent">- <html:errors property="baseUrl"/></span>            
          				</td>
        			</tr>
			</logic:messagesPresent>	
	    </table> 
  	...
  	<tr>
	    ...
	    <table width="100%" cellpadding="0" cellspacing="0" border="0">
	    	<tr>
				<logic:messagesPresent property="senderEmail">
         				<td class="ErrorField">
           				<html:text size="31" property="senderEmail" />
         				</td> 
				</logic:messagesPresent>
				<logic:messagesNotPresent property="senderEmail"> 
					<td class="BlockContent">
           				<html:text size="31" property="senderEmail" />
         				</td> 
				</logic:messagesNotPresent>
			...
			<logic:messagesPresent property="senderEmail">
        			<tr>
          				<td class="ErrorField" colspan="2">
            				<span class="ErrorFieldContent">- <html:errors property="senderEmail"/></span>            
          				</td>
        			</tr>
			</logic:messagesPresent>	
	    </table> 
