...
<!-- PLATFORM CONTENTS -->
	<tr class="ListHeaderDark">
      <td width="85%" class="ListHeaderInactiveSorted"><fmt:message key="resource.hub.PlatformTypeTHs"/></td>
...
<!-- Platform Services -->
	<tr class="ListHeaderDark">
      <td width="85%" class="ListHeaderInactiveSorted" colspan="100%"><fmt:message key="resource.hub.PlatformServiceTypeTHs"/></td>
  	</tr>
...
<!-- SERVER CONTENTS -->
	<tr>
      <td class="ListCellHeaderSorted" colspan="100%"><fmt:message key="resource.hub.ServerTypeTHs"/></td>
	</tr>
