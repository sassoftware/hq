 ...
 <tr valign="top">
  ...
  <html:img page="/images/icon_required.gif" width="9" height="9" border="0"/>
   ...
   <!--
	...
	-->
    <input type="hidden" size="31" maxlength="40" name="newPassword" tabindex="4" value='<bean:message bundle="ee" key="admin.user.changePassword.DefaultPassword"/>'>
	<!--
	<br>
	...
	-->
    <input type="hidden" size="31" maxlength="40" name="confirmPassword" tabindex="5" value='<bean:message bundle="ee" key="admin.user.changePassword.DefaultPassword"/>'>
	<!--
	<br>
        <c:if test="${passwordMessagesPresent}">
        <div class="ErrorField">
