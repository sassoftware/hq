  ...
  <tr>
    ...
    <td width="50%" valign="top">
      ...
      <div id="<c:out value="${widgetInstanceName}"/>FromDiv">
        ...
        <display:table padRows="true" rightSidebar="true" items="${availableResGrps}" var="group" action="${selfPaAction}" orderValue="soa" order="${param.soa}" sortValue="sca" sort="${param.sca}" pageValue="pna" page="${param.pna}" pageSizeValue="psa" pageSize="${param.psa}" styleId="fromTable" width="100%" cellpadding="0" cellspacing="0" border="0">
          ...
          <display:column property="name" title="common.header.Group" sortAttr="2" defaultSort="true" width="50%"/>
...
<tiles:insert definition=".toolbar.new">
  <tiles:put name="useFromSideBar" value="true"/>
  <tiles:put name="listItems" beanName="availableResGrps"/>
  <tiles:put name="listSize" beanName="numAvailableResGrps"/>
  ...
  <tiles:put name="pageNumAction" beanName="selfPnaAction"/>
    ...
    <td width="50%" valign="top">
      ...
      <div  id='<c:out value="${widgetInstanceName}"/>ToDiv'>
        ...
        <display:table padRows="true" leftSidebar="true" items="${pendingResGrps}" var="group" action="${selfPpAction}" orderValue="sop" order="${param.sop}" sortValue="scp" sort="${param.scp}" pageValue="pnp" page="${param.pnp}" pageSizeValue="psp" pageSize="${param.psp}" styleId="toTable" width="100%" cellpadding="0" cellspacing="0" border="0">
...
<tiles:insert definition=".toolbar.new">
  ...
  <tiles:put name="useToSideBar" value="true"/>
  <tiles:put name="listItems" beanName="pendingResGrps"/>
  <tiles:put name="listSize" beanName="numPendingResGrps"/>
