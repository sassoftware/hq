...
<link rel="stylesheet" type="text/css" href="<spring:url value="/css/HQ_40.css"/>" />
...
<section id="pluginManagerPanel" class="container top">
    <div class="fieldsetTitle"><fmt:message key="admin.managers.plugin.title" /></div>
...
<c:if test="${mechanismOn}" >
    <div id="uploadPanel" style="visibility:hidden;">
            ...
            <p>
                ...
                <p id="afterSelectFileInstruction" style="text-align:left; margin:0px;"><fmt:message key="admin.managers.plugin.upload.dialog.instruction.after" /></p>
            </p>
            ...
            <div id="uploadButtonBar">
                ...
                <input type="button" value="<fmt:message key='admin.managers.plugin.button.cancel' />" class="cancelLink" />
            </div>
    </div>
...
<div id="showStatusPanel" style="visibility:hidden;">
    ...
    <div id="statusButtonBar">
		<input type="button" value="<fmt:message key='admin.managers.plugin.button.close' />" class="cancelLink" />        
    </div>
</div>
        ...
        hqDojo.behavior.add({
            ...
            "#agentStatusHelp":{
                onclick: function(e){
                     ...
                     var helpWin=window.open(helpHref,'SASDoc','width=800,height=650,scrollbars=yes,toolbar=yes,left=80,top=80,resizable=yes');
                     helpWin.focus();
                }
            },
            "#agentSummaryHelp":{
