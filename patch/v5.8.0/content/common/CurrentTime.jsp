...
var st = hqDojo.date.locale.format(d, {formatLength:'medium'});

hqDojo.byId("currentTime").innerHTML = st+hqDojo.byId("currentTime").innerHTML;
</jsu:script>
<div id="currentTime">&nbsp;&nbsp;<c:out value="${owner}"/></div>