...
<c:choose>
  <c:when test="${not empty useDisableBtn && useDisableBtn}">
    <c:set var="removeImg" value="button.disablecollection"/>
  </c:when>
  <c:otherwise>
    <c:set var="removeImg" value="button.removefromlist"/>
...
<table width="100%" cellpadding="5" cellspacing="0" border="0" class="ToolbarContent">
  <tr>
    ...
    <c:if test="${showRemoveBtn}">
	    ...
	    <td id="<c:out value="${widgetInstanceName}"/>DeleteButtonTd"><div id="<c:out value="${widgetInstanceName}"/>DeleteButtonDiv"><input id="<c:out value="${widgetInstanceName}"/>DeleteButton" type="button" class="compactbuttoninactive" value="<fmt:message key='${removeImg}' />" disabled="disabled" /></div></td>
	    </c:when>
	    <c:otherwise>
...
%>
   <td width="100%" id="<c:out value="${widgetInstanceName}"/>GoButtonTd"><div id="<c:out value="${widgetInstanceName}"/>GoButtonDiv"><input id="<c:out value="${widgetInstanceName}"/>GoButton" type="image" style="padding-left: 6px; vertical-align: text-bottom;" src="/images/4.0/icons/accept.png" disabled="disabled" /></div></td>
<%   
  }else{
%>
   <td width="100%" id="<c:out value="${widgetInstanceName}"/>GoButtonTd"><div id="<c:out value="${widgetInstanceName}"/>GoButtonDiv"><input id="<c:out value="${widgetInstanceName}"/>GoButton" type="button" class="compactbuttoninactive" value="<fmt:message key='button.go' />" disabled="disabled" /></div></td>
<%}%>
</c:if>
...
<td id="<c:out value="${widgetInstanceName}"/>IndButtonTd"><div id="<c:out value="${widgetInstanceName}"/>IndButtonDiv"><input id="<c:out value="${widgetInstanceName}"/>GoButton" type="button" class="compactbuttoninactive" value="<fmt:message key='button.go' />" disabled="disabled" /></div></td>
</c:if>
