...
public abstract class Chart extends WebImage
{
    ...
    public String m_strNoDataOnLocale = ""; 
    ...
    /**
     * Add 4 lables to support I18N in metric charts
     */
    private String averageLabel = "Average";;
    
    private String baselineLabel = "Baseline";;
    
    private String lowLabel = "Low";;
    
    private String peakLabel = "Peak";;
	...
	public void setPeakLabel(String peakLabel) {
