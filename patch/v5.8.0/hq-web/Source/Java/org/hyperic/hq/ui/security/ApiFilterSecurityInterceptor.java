...
public class ApiFilterSecurityInterceptor extends FilterSecurityInterceptor 
{
	...
	public void invoke(FilterInvocation fi) throws IOException, ServletException
	{
		...
		try {
		    ...
		    String webflag = request.getParameter("webflag");
		    
		    if(webflag != null && "true".equals(webflag)){
		    	log.info("Session " + RequestUtils.getSessionIdInt(request) + " requested from web page, leaving active ");
		    	return;
		    }
