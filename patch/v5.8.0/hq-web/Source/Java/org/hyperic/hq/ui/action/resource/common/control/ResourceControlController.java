        ...
        try {
            ...
            if (isEnabled) {
                try {
                    ...
                    log.info("hasControlActions is "+hasControls);
                    java.util.List options = org.hyperic.hq.ui.beans.OptionItem.createOptionsList(actions);
                    request.setAttribute("controlActions", options);
                    //log.info("options size is "+options.size());
                    //log.info("resourceAction is "+request.getAttribute("resourceAction"));
