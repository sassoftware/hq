...
public class MetricChartServlet extends VerticalChartServlet {
    ...
    protected Chart createChart(HttpServletRequest request,
        ...
        java.util.ResourceBundle rb = java.util.ResourceBundle.getBundle("ApplicationResources", request.getLocale());

        if (plotLineChart) {
            log.trace("plotting a line chart");
            LineChart lineChart = new LineChart(getImageWidth(request),
                    getImageHeight(request)); 
            lineChart.m_strNoDataOnLocale="No Metric Data Available";
            try{
            	lineChart.m_strNoDataOnLocale=rb.getString("No.Metric.Data.Available");
            }catch(Exception e){
            	e.printStackTrace();
            }
            ...
            ColumnChart columnChart = new ColumnChart(getImageWidth(request),
                    getImageHeight(request)); 
            columnChart.m_strNoDataOnLocale="No Metric Data Available";
            try{
            	columnChart.m_strNoDataOnLocale=rb.getString("No.Metric.Data.Available");
            }catch(Exception e){
            	e.printStackTrace();
            }
    ...
    protected void initializeChart(Chart chart, HttpServletRequest request) {
        ...
        verticalChart.setAverageLabel(request.getParameter("averageLabel")!=null?request.getParameter("averageLabel"):"Average");
        verticalChart.setBaselineLabel(request.getParameter("baselineLabel")!=null?request.getParameter("baselineLabel"):"Baseline");
        verticalChart.setLowLabel(request.getParameter("lowLabel")!=null?request.getParameter("lowLabel"):"Low");
        verticalChart.setPeakLabel(request.getParameter("peakLabel")!=null?request.getParameter("peakLabel"):"Peak");
        verticalChart.setUnitLegend(request.getParameter("timeLabel")!=null?request.getParameter("timeLabel"):"TIME");
        verticalChart.setValueLegend(request.getParameter("valueLabel")!=null?request.getParameter("valueLabel"):"VALUE");
    }
