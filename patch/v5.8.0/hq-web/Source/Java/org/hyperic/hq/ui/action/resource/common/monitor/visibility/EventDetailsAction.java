...
public class EventDetailsAction
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
        ...
        if (events.size() == 0) {
    		...
    		SimpleDateFormat df = (SimpleDateFormat) SimpleDateFormat.getDateTimeInstance(DateFormat.MEDIUM, DateFormat.SHORT, reqlocale);
            ...
            for (EventLog elv : events) {
                ...
                html.append(StringEscapeUtils.escapeHtml(res.getMessage(request.getLocale(),elv.getType(), df.format(elv.getTimestamp()),
