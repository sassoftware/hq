...
import org.hyperic.hq.measurement.server.session.GlobalTime;
...
public class EditConfigPropertiesAction
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
        ...
        try {
            ...
            try {
				ServerValue sv = appdefBoss.findServerById(sessionInt, aeid.getID());
				if((sv!=null)){
				...
				log.info("The object "+aeid.getID()+" May not be a server object.So do nothing.");
				log.debug("The object "+aeid.getID()+" May not be a server object.So do nothing.",e);
			}
