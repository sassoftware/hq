...
public class DBUtil {
    ...
    public static final int DATABASE_POSTGRESQL_10 = 12;
    ...
    public static int getDBType(Connection conn) throws SQLException {
        ...
        if (dbTypeInteger == null) {
            ...
            log.info("getDBType: dbName='" + dbName + "', version='" + dbVersion + "'");
